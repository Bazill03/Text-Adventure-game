//Objects
//Arrange in alphabetical order one day
var objects = {
    serum: {
        name: "serum",
        owned: false,
        consider: function() {
            print("Glowing bright blue and viscous. Used as a torture method to make shardkeepers attack those who are unpure.");
        }
    },
    torch: {
        name: "torch",
        owned: false,
        consider: function() {
            print("The bright dancing flames warm you, giving you the feeling of safety");
        }
    },
    skeletonkey: {
        name: "Old Copper Key",
        owned: false,
        consider: function() {
            print("You look over the key. It seems to be made of rusted copper. Bits and pieces of green flaking off to reveal the dull copper underneath. The notches seem worn down to almost nothing.");
        },
        findText: function() {
    ...
    thronescroll: {
        //Found in the throne room on the throne.
        name: "Thaddius' scroll",
        owned: false,
        consider: function() { print("Yellowed with age and has the distinct smell of sage.") }
    }
}
