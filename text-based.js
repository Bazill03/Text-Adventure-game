...
$(document).ready(function() {
    ...
    var gameData = {
        ...
        rooms: [{
            ...
            }, //end of room 12 commands
            {
                ...
                look: ['door leading east', 'sconce', 'skeletons', 'back to the great hall'],
                description: function() {
                    if (currentRoom.skeletonsDefeated == false) {
                        print("You pass through the door leading east and find yourself in a cramped hallway. The low, arched ceiling looms above you. On the wall there's an unlit sconce which you light with your torch. The sconce flares to life spilling light throughout the room. Ahead, you see two skeletons, pieces of flesh still lingering on their pale white bodies. They stand still as statues, their empty sockets turned towards you.");
                    } else {
                        print("You are back in the cramped hallway. The sconce on the wall still glows brightly.");
                    }
                },
                ...
                commands: [{
                        ...
                        result: function() {
                            print("The skeletons continue to stare into you. Clenched in their hands are fresh blades that reflect the dancing sconce. Their skulls following you as you move around the cramped hallway but otherwise, they stand motionless.");
                            print("You can choose to attack them by typing attack.", "intColor");
                        }
                    },
                    {
                        input: 'look sconce',
                    ...
                    },
                    {
                        ...
                        result: function() {
                            if (currentRoom.skeletonsDefeated == false) {
                                print("You try to get a better look at the door leading east. But the skeletons block your path.");
                            } else {
                                print("Another solid maple door hinged in cold black iron. You gaze through the keyhole but see only a glowing green light.");
                            }
                        }
                    },
                    {
                        ...
                        result: function() {
                            ...
                            combat(player, hallwaySkeletonOne, hallwaySkeletonTwo, "skeletons");
                            currentRoom.skeletonsDefeated = true;
                        }
                    },
                    {
                        input: 'open door leading east',
                        result: function() {
                            if (currentRoom.skeletonsDefeated == false) {
                                ...
                                currentRoom = gameData.rooms[14]; //Necromancers Alcove
                                player.travelHistory.push(currentRoom);
                                currentRoom.description();
                                moveThroughDoor.play();
                            }
    ...
    function attachListeners() {
        ...
        //Skill Up
        document.getElementById('strButton').addEventListener("click", increaseStr, false);
        document.getElementById('intButton').addEventListener("click", increaseInt, false);
        document.getElementById('agiButton').addEventListener("click", increaseAgi, false);
        document.getElementById('chrButton').addEventListener("click", increaseChr, false);
    ...
    //These functions are a jumbled mess. They increase the players stat of a given choice so long as the player has points to spend.
    //It then refreshes the players stats doing the math for any increases in health or mana.
    //Super ugly though.

    function decreaseLevelUpPoints() {
        player.pointsToSpend = player.pointsToSpend - 1;
        $("#pointsRemaining").html(String(player.pointsToSpend));
    }
    ...
    function useWeapon() {
        ...
        if (
            ...
            if (player.weaponDamageType == enemy.immune) {
                combatPrint("The enemy is immune to your attack!");
                playerTurn = false;
                checkTheDead();
                turnCounter--;
                setTimeout(function() {
